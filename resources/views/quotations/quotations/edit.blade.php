                            ...
                            <table id="quotationTriffDischarge" class="table table-bordered">
                                ...
                                @foreach($quotation->quotationDesc as $key=>$desc)
                                    <tr id="quotationTriffDischargeRow">
                                        ...
                                        <td>
                                            ...
                                            data-size="10" title="{{trans('forms.select')}}">
                                                @foreach ($equipment_types as $item)
                                                    <option value="{{$item->id}}" {{$item->id == old('equipment_type_id') || $item->id == $desc->equipment_type_id ? 'selected':'disabled'}}>{{$item->name}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <td>
                                            <input type="text" id="quotationDis" name="quotationDis[{{$key}}][ofr]" class="form-control" autocomplete="off"  value="{{old('ofr',$desc->ofr)}}" readonly>
                                            @error('charge_type')
                                            <div style="color:red;">
                                                {{$message}}
                                            </div>
