    ...
    <div class="row layout-top-spacing">
            ...
            <div class="widget widget-one">
                <div class="widget-heading hide">
                    <nav class="breadcrumb-two" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('booking.index')}}">Import Booking </a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);"> Arrival Notification</a></li>
        ...
        <table>
            <tr>
                ...
                <td colspan="2">{{optional(Auth::user())->agent->name}}</td>
                <td colspan="2">To:</td>
                <td colspan="2">{{optional(optional($booking)->consignee)->name}}</td>
        ...
        <table>
            ...
            <!-- <tr>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <button onclick="window.print()" class="btn btn-primary hide mt-3">Print This Arrival Notification </button>
                    </div>
                </div>
            </div>
        </div>
