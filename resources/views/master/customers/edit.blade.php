                ...
                <div class="widget widget-one">
                    ...
                    <div class="widget-content widget-content-area">
                        <form novalidate id="createForm" action="{{route('customers.update',['customer'=>$customer])}}"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="countryInput">Currency<span class="text-warning"> * </span></label>
...
$(document).ready(function(){
    ...
    $("#add").click(function(){
            var tr = '<tr>'+
        '<td><select class="selectpickers form-control" data-live-search="true" name="customerRole['+counter+'][role_id]" data-size="10"><option>Select</option>@foreach ($roles as $role)<option value="{{$role->id}}">{{$role->name}}</option>@endforeach</select></td>'+
