                    ...
                    <form id="invoiceForm" action="{{route('dententions.store')}}" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="selectpicker form-control" id="booking_no" data-live-search="true" name="booking_no" data-size="10" title="{{trans('forms.select')}}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="selectpicker form-control" id="port" data-live-search="true" name="container_ids[]" data-size="10" title="{{trans('forms.select')}}" required multiple>
                                    <option value="all" {{ "all" == old('container_ids',isset($input) ? $input['container_ids'] : '') ? 'selected':'hidden'}}>
                                        All
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>From</label>
                                <select class="selectpicker form-control" data-live-search="true" name="from" data-size="10" id="from_code" title="{{trans('forms.select')}}">
                                    @foreach ($movementsCode as $item)
                                    <option value="{{$item->id}}" {{$item->id == old('from',isset($input) ? $input['from'] : '') || $item->code == 'DCHF'  ? 'selected' : ''}}>{{$item->code}}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('from'))
                            ...
                            <div class="form-group col-md-6">
                                <label>To</label>
                                <select class="selectpicker form-control" data-live-search="true" name="to" data-size="10" id="to_code" title="{{trans('forms.select')}}">
                                    @foreach ($movementsCode as $item)
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" name="to_date" class="form-control" value="{{old('to_date',isset($input) ? $input['to_date'] : '')}}">
                                @if ($errors->has('to_date'))
                                <span class="text-danger">{{ $errors->first('to_date') }}</span>
                                @endif
                            </div>
                            <div class="form-group col-md-2 mt-5 ml-2">
                                <input type="checkbox" id="apply_first_day" name="apply_first_day" value="1" {{ isset($input['apply_first_day']) ?  'checked': '' }} checked>
                                <label for="apply_first_day">{{ trans('home.add_first') }}</label>
                            </div>
                            <div class="form-group col-md-2 mt-5 ml-2">
                                <input type="checkbox" id="apply_last_day" name="apply_last_day" value="1" {{ isset($input['apply_last_day']) ?  'checked': '' }}>
